	...
	tilepal 0, ROOF, ROOF, GRAY, GRAY, GREEN, GREEN, GREEN, GREEN
	tilepal 0, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, ROOF, GRAY, GRAY, GRAY, GRAY, GREEN, GREEN, GREEN
...
endr
	...
	tilepal 1, YELLOW, YELLOW, YELLOW, YELLOW, GRAY, ROOF, ROOF, ROOF
	tilepal 1, RED, RED, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY
